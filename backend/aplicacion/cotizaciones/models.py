...
class Cliente(models.Model):
    empresa = models.CharField(max_length=10, null=True, verbose_name='Nombre cliente')
...
class Producto(models.Model):
    ...
    valorUnidad = models.SmallIntegerField(verbose_name='Valor por unidad', null=True, blank=True)
...
# insert into cotizaciones_cliente ('empresa', 'contacto', 'telefonoContacto', 'correoContacto') values ('Salfa S.A.', 'Cesar Cisterna', '+56987654321', 'cesar@salfa.cl');
# insert into cotizaciones_cliente ('empresa', 'contacto', 'telefonoContacto', 'correoContacto') values ('Microsoft', 'Bill Gates', '+56934567890', 'bill@microsoft.com');
# insert into cotizaciones_cliente ('empresa', 'contacto', 'telefonoContacto', 'correoContacto') values ('Amazon', 'Jeff Bezos', '+56921098765', 'jeff@amazon.com');
# insert into cotizaciones_cliente ('empresa', 'contacto', 'telefonoContacto', 'correoContacto') values ('Tesla', 'Elon Musk', '+56945678901', 'elon@tesla.com');
# insert into cotizaciones_cliente ('empresa', 'contacto', 'telefonoContacto', 'correoContacto') values ('Jumbo', 'Horst Paulmann', '+56954321987', 'horst@jumbo.cl');

# insert into cotizaciones_producto ('producto', 'marca', 'fabricante', 'valorUnidad') values ('Jotafloor Solvent Free Primer', 'Jotun', 'Codelpa', 289000);
# insert into cotizaciones_producto ('producto', 'marca', 'fabricante', 'valorUnidad') values ('Jotafloor SL Universal', 'Jotun', 'Codelpa', 289000);

# insert into cotizaciones_servicio ('nombre', 'descripcion', 'valorMetroCuadrado') values ('Mantencion multicapa', '- Determinación del espesor de película seca
